...
export default function EventTourQuestion({ config }: { config: EventConfig }) {
          ...
          {!wantsTour ? (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <img
                    src={config.heroOptions[0]?.img || '/images/venue-exterior-night-fountains.webp'}
                    alt="Just call me"
                    className="w-full aspect-[4/3] object-cover"
                  />
                  <div className="py-3 px-3 text-center font-bold text-base bg-blue text-white flex-1 flex items-center justify-center">
