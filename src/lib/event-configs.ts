...
export const corporateConfig: EventConfig = {
  ...
  features: [
    { icon: '🎤', title: 'Full AV & staging', desc: 'Projectors, sound systems, podiums included' },
    ...
    { icon: '📋', title: 'Dedicated coordinator', desc: 'Your point person from planning to breakdown' },
  ...
  faq: [
    { question: 'What AV equipment is included?', answer: 'Our venue includes a built-in sound system, wireless microphones, a projector with screen, and stage lighting. Additional equipment can be arranged through our preferred vendors.' },
    { question: 'Can we customize the room layout?', answer: 'Absolutely. We offer boardroom, theater, banquet, cocktail, and hybrid configurations. Our team will help you find the best setup for your group size and event format.' },
    ...
    { question: 'Can we bring in outside vendors?', answer: 'We handle catering and bar service in-house, but welcome outside entertainment, decor, and AV vendors. Our coordinator will help manage all vendor logistics.' },
  ],
  ctaText: 'Impress your team. Elevate your event.',
  ctaSubtext: 'Talk to one of our event coordinators and see if we are the right fit.',
  ...
  detailFields: [
    ...
    { key: 'eventSubType', type: 'select', label: 'Type of event', options: ['Conference / Seminar', 'Awards Ceremony', 'Team Building', 'Product Launch', 'Client Appreciation', 'Networking Event', 'Company Milestone', 'Fundraiser / Gala', 'Other'], required: true },
    { key: 'cateringStyle', type: 'select', label: 'Catering preference', options: ['Plated Dinner', 'Buffet', 'Cocktail Reception', 'Breakfast / Lunch Meeting', 'Not Sure Yet'], required: false },
  ],
  roles: [
  ...
  thankYouText: 'One of our event coordinators will personally reach out within 24 hours to discuss your corporate event.',
...
export const holidayConfig: EventConfig = {
  slug: 'holiday',
  eventType: 'Holiday Parties',
  heroTagline: "Detroit's Waterfront Venue",
  heroHeadline: 'Throw the holiday party they will actually talk about',
  heroQuestion: 'Have you celebrated at The Roostertail?',
  heroOptions: [
    { label: 'Yes!', img: '/images/roostertail-204_websize.webp' },
    { label: 'Not yet', img: '/images/roostertail-82_websize.webp' },
  ],
  socialProofText: 'Detroit\'s favorite holiday party destination',
  socialProofSubtext: 'Over 10,000 celebrations hosted since 1958.',
  features: [
    { icon: '🎄', title: 'Festive atmosphere', desc: 'A stunning venue that sets the holiday mood' },
    ...
    { icon: '🎶', title: 'Entertainment ready', desc: 'DJ, live band, or your own entertainment' },
  ...
  testimonials: [
    ...
    },
    {
      ...
      img: '/images/roostertail-82_websize.webp',
    },
    {
      quote: "the live band, the dance floor, the cocktails by the water. it felt like a real celebration, not just another office party. booking again next year.",
      name: 'Regional Law Firm',
      img: '/images/roostertail-475_websize.webp',
    },
  ],
  gallery: [
    { src: '/images/roostertail-204_websize.webp', alt: 'Holiday party celebration' },
    { src: '/images/roostertail-586_websize.webp', alt: 'Festive celebration' },
    { src: '/images/roostertail-588_websize.webp', alt: 'Holiday ambiance' },
    { src: '/images/roostertail-848_websize.webp', alt: 'Elegant holiday gathering' },
    { src: '/images/roostertail-82_websize.webp', alt: 'Waterfront celebration' },
    { src: '/images/roostertail-475_websize.webp', alt: 'Party in full swing' },
  ],
  aboutHeadline: "The holiday celebration they deserve",
  aboutText: [
    "Whether it's a company holiday party for 300 or an intimate family gathering, The Roostertail on the Detroit River creates the kind of celebration people remember.",
    "Our team handles everything from custom menus to entertainment coordination so you can enjoy the party alongside your guests.",
  ],
  aboutImages: ['/images/roostertail-204_websize.webp', '/images/roostertail-82_websize.webp'],
  faq: [
    { question: 'How early should we book for the holidays?', answer: 'Prime December dates fill up fast. We recommend inquiring by September or October to secure your preferred date. January and February dates have more flexibility.' },
    { question: 'Can you handle large company parties?', answer: 'Absolutely. Our venue accommodates up to 400+ guests and we regularly host corporate holiday events for large organizations.' },
    ...
    { question: 'What entertainment options are available?', answer: 'We can arrange DJs, live bands, photo booths, and more. You are also welcome to bring your own entertainment.' },
    { question: 'Can we do a cocktail-style party instead of seated?', answer: 'Yes! Cocktail receptions are very popular for holiday events. We offer appetizer stations, passed hors d\'oeuvres, and bar setups designed for mingling.' },
  ],
  ctaText: 'Make this holiday season one to remember.',
  ctaSubtext: 'Talk to one of our event coordinators about your holiday event.',
  dateHeadline: 'When is the party?',
  dateSubtext: 'Popular dates fill quickly during the holidays',
  dateOptions: [
    { label: 'November', icon: '🍂', img: '/images/roostertail-475_websize.webp' },
    { label: 'December', icon: '🎄', img: '/images/roostertail-204_websize.webp' },
    { label: 'January', icon: '🥂', img: '/images/roostertail-588_websize.webp' },
    { label: 'Other month', icon: '📅', img: '/images/roostertail-82_websize.webp' },
  ],
  guestCountHeadline: 'How many guests?',
  guestCountSubtext: 'Helps us recommend the right setup',
  guestCountOptions: [
    { label: 'Under 50', icon: '🎄', img: '/images/roostertail-586_websize.webp' },
    { label: '50-150', icon: '🎉', img: '/images/roostertail-82_websize.webp' },
    { label: '150-300', icon: '🥂', img: '/images/roostertail-82_websize.webp' },
    { label: '300+', icon: '✨', img: '/images/roostertail-475_websize.webp' },
  ],
  ...
  detailFields: [
    ...
    { key: 'occasion', type: 'select', label: 'What are you celebrating?', options: ['Christmas / Holiday', 'New Year\'s Eve', 'Thanksgiving', 'Halloween', 'Valentine\'s Day', 'Other'], required: true },
    { key: 'atmosphere', type: 'select', label: 'Preferred vibe', options: ['Formal Seated Dinner', 'Casual Cocktail Party', 'Dance Party', 'Family-Friendly Celebration'], required: true },
    { key: 'entertainment', type: 'select', label: 'Entertainment needs', options: ['DJ', 'Live Band', 'Photo Booth', 'No Entertainment Needed', 'Not Sure Yet'], required: false },
  ],
  roles: [
    { label: 'Event Planner', img: '/images/roostertail-586_websize.webp' },
    { label: 'Office Manager', img: '/images/roostertail-848_websize.webp' },
    { label: 'Host / Hostess', img: '/images/roostertail-82_websize.webp' },
    { label: 'Other', img: '/images/roostertail-204_websize.webp' },
  ],
  roleHeadline: 'Who is planning this?',
  roleSubtext: 'Helps us personalize your experience',
  formHeadline: "Let's plan your holiday celebration",
  formSubtext: 'Our events team will personally reach out within 24 hours.',
  nameLabel: 'Your name',
  secondFieldLabel: 'Company or group name',
  submitText: 'Check availability \u2192',
  thankYouHeadline: "Let's make it a celebration",
  thankYouText: 'One of our event coordinators will personally reach out within 24 hours to discuss your holiday event.',
...
export const promConfig: EventConfig = {
  ...
  features: [
    ...
    { icon: '🎶', title: 'Sound system', desc: 'Professional DJ-ready sound & speakers' },
    ...
    { icon: '🥤', title: 'Non-alcoholic bar', desc: 'Mocktails, punch, soft drinks included' },
    { icon: '🅿️', title: 'On-site parking', desc: 'Safe, well-lit parking for students' },
    { icon: '🔒', title: 'Security included', desc: 'Professional security on-site' },
    { icon: '📋', title: 'Event coordinator', desc: 'We handle all the logistics' },
  ...
  faq: [
    ...
    { question: 'Is alcohol served at prom events?', answer: 'No. We provide a full non-alcoholic bar with mocktails, punch stations, and soft drinks.' },
    { question: 'What about security?', answer: 'Professional security is included. We also work with your school administration on entry procedures and guest list management.' },
    { question: 'Can we bring our own DJ?', answer: 'Yes! You can bring your own DJ or entertainment, or we can connect you with our preferred vendors.' },
  ...
  ctaSubtext: 'Talk to one of our event coordinators about prom.',
  dateHeadline: 'When is prom?',
  dateSubtext: 'Popular spring dates fill up quickly',
  dateOptions: [
    { label: 'April 2026', icon: '🌷', img: '/images/events/dsc03447.webp' },
    { label: 'May 2026', icon: '🌸', img: '/images/roostertail-934_websize.webp' },
    { label: 'June 2026', icon: '☀️', img: '/images/events/venue-lobby-grand-staircase-blue-accent-wall.webp' },
    { label: '2027 or later', icon: '🔮', img: '/images/roostertail-447_websize.webp' },
  ],
  ...
  detailFields: [
    ...
    { key: 'entertainment', type: 'select', label: 'Entertainment', options: ['We have our own DJ', 'Need a DJ recommendation', 'Need a photo booth', 'Not Sure Yet'], required: false },
  ],
  roles: [
  ...
  roleHeadline: 'Who is planning prom?',
  roleSubtext: 'Helps us personalize your experience',
  ...
  thankYouText: 'One of our event coordinators will personally reach out within 24 hours to discuss your prom.',
...
export const birthdayConfig: EventConfig = {
  ...
  features: [
    ...
    { icon: '🥂', title: 'Full bar service', desc: 'Open bar, cash bar, or custom packages' },
    { icon: '🎶', title: 'Entertainment ready', desc: 'DJ-ready sound system and dance floor' },
    ...
    { icon: '📋', title: 'Event coordinator', desc: 'We handle the logistics' },
  ...
  faq: [
    ...
    { question: 'Can we bring our own entertainment?', answer: 'Yes! Bring your own DJ, band, or performers. Our venue has a professional sound system ready to use.' },
  ],
  ctaText: 'Give them a celebration they deserve.',
  ctaSubtext: 'Talk to one of our event coordinators about your birthday event.',
  ...
  thankYouText: 'One of our event coordinators will personally reach out within 24 hours to discuss your birthday event.',
...
export const showerConfig: EventConfig = {
  ...
  features: [
    ...
    { icon: '🎮', title: 'Games area', desc: 'Space for activities and entertainment' },
  ...
  faq: [
    { question: 'What times are available for showers?', answer: 'We offer morning brunch (10am-1pm), afternoon (1pm-4pm), and evening (5pm-9pm) time slots. Morning and afternoon are most popular for showers.' },
    { question: 'What is the minimum guest count?', answer: 'We can accommodate intimate showers starting at 20 guests up to 100+ guests.' },
  ...
  ctaSubtext: 'Talk to one of our event coordinators about your shower.',
  ...
  detailFields: [
    ...
    { key: 'eventStyle', type: 'select', label: 'Vibe', options: ['Elegant / Formal', 'Casual / Fun', 'Themed', 'Garden Party Style'], required: true },
    { key: 'catering', type: 'select', label: 'Catering preference', options: ['Brunch', 'Lunch', 'Appetizers / Light Bites', 'Desserts / Sweets Table', 'Not Sure Yet'], required: false },
  ],
  roles: [
    { label: 'Maid of Honor', img: '/images/events/dsc05521.webp' },
    { label: 'Bridesmaid / Friend', img: '/images/events/dsc03600.webp' },
    { label: 'Family Member', img: '/images/events/elegant-place-setting-emerald-table-runner-overhead.webp' },
  ...
  thankYouText: 'One of our event coordinators will personally reach out within 24 hours to discuss your shower.',
...
export const otherConfig: EventConfig = {
  ...
  features: [
    ...
    { icon: '🎶', title: 'Entertainment ready', desc: 'Sound system, stage, and dance floor' },
    { icon: '🌅', title: 'Waterfront views', desc: 'Right on the Detroit River' },
    { icon: '🅿️', title: 'On-site parking', desc: 'Convenient self-parking included' },
    { icon: '📋', title: 'Event coordinator', desc: 'Your point person for planning' },
  ...
  gallery: [
    ...
    { src: '/images/events/temptations-motown-group-blue-suits-venue-entrance.webp', alt: 'Live entertainment' },
  ...
  faq: [
    ...
    { question: 'Can we customize the menu?', answer: 'Absolutely. Our chef works with you to create a menu that fits your event, dietary needs, and budget.' },
  ...
  ctaSubtext: 'Talk to one of our event coordinators.',
  ...
  detailFields: [
    { key: 'eventSubType', type: 'select', label: 'Type of event', options: ['Reunion', 'Fundraiser / Gala', 'Memorial / Celebration of Life', 'Retirement', 'Graduation', 'Religious Ceremony', 'Quinceañera', 'Other'], required: true },
    { key: 'eventStyle', type: 'select', label: 'Event style', options: ['Formal', 'Semi-Formal', 'Casual', 'Cocktail'], required: true },
    { key: 'catering', type: 'select', label: 'Catering needs', options: ['Full Dinner Service', 'Light Refreshments', 'Bar Only', 'Not Sure Yet'], required: false },
  ...
  thankYouText: 'One of our event coordinators will personally reach out within 24 hours to discuss your event.',
