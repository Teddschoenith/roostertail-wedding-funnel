...
export const corporateConfig: EventConfig = {
  ...
  dateOptions: [
    { label: '1-3 months', icon: '🗓️', img: '/images/roostertail-475_websize.webp' },
    { label: '3-6 months', icon: '📆', img: '/images/roostertail-586_websize.webp' },
    { label: '9-12 months', icon: '📅', img: '/images/roostertail-82_websize.webp' },
    { label: '12+ months', icon: '🔮', img: '/images/roostertail-204_websize.webp' },
  ],
...
export const promConfig: EventConfig = {
  ...
  aboutImages: ['/images/events/dsc05537.webp', '/images/events/ballroom-empty-setup-paper-lanterns-waterfront-golden-hour.webp'],
  faq: [
  ...
  dateOptions: [
    ...
    { label: 'June 2027', icon: '☀️', img: '/images/roostertail-204_websize.webp' },
  ...
  roles: [
    ...
    { label: 'Teacher / Advisor', img: '/images/roostertail-475_websize.webp' },
    { label: 'Prom Committee', img: '/images/roostertail-509_websize.webp' },
  ],
  roleHeadline: 'Who are you?',
  roleSubtext: 'Helps us personalize your experience',
...
export const birthdayConfig: EventConfig = {
  ...
  dateOptions: [
    { label: '1-3 months', icon: '🗓️', img: '/images/roostertail-263_websize.webp' },
    { label: '3-6 months', icon: '📆', img: '/images/roostertail-833_websize.webp' },
    { label: '9-12 months', icon: '📅', img: '/images/roostertail-475_websize.webp' },
    { label: '12+ months', icon: '🔮', img: '/images/catering-hors-doeuvres-service.webp' },
  ],
  guestCountHeadline: 'How many guests?',
  guestCountSubtext: 'Helps us recommend the right setup',
  guestCountOptions: [
...
export const showerConfig: EventConfig = {
  ...
  aboutImages: ['/images/roostertail-475_websize.webp', '/images/catering-hors-doeuvres-service.webp'],
  faq: [
  ...
  dateSubtext: 'Helps us check availability',
  dateOptions: [
    { label: '1-3 months', icon: '🗓️', img: '/images/events/elegant-place-setting-emerald-table-runner-overhead.webp' },
    { label: '3-6 months', icon: '📆', img: '/images/events/greetingcardconferenceevent-348.webp' },
    { label: '9-12 months', icon: '📅', img: '/images/events/canned-seltzers-ice-bucket-bar-display.webp' },
    { label: '12+ months', icon: '🔮', img: '/images/roostertail-242_websize.webp' },
  ],
  guestCountHeadline: 'How many guests?',
  ...
  roles: [
    ...
    { label: 'Mother / Family Member', img: '/images/roostertail-263_websize.webp' },
...
export const otherConfig: EventConfig = {
  ...
  aboutImages: ['/images/roostertail-586_websize.webp', '/images/guests-packed-ballroom-event.webp'],
  faq: [
  ...
  dateSubtext: 'Helps us check availability',
  dateOptions: [
    { label: '1-3 months', icon: '🗓️', img: '/images/events/greetingcardconferenceevent-25.webp' },
    { label: '3-6 months', icon: '📆', img: '/images/events/greetingcardconferenceevent-294.webp' },
    { label: '9-12 months', icon: '📅', img: '/images/roostertail-848_websize.webp' },
    { label: '12+ months', icon: '🔮', img: '/images/events/greetingcardconferenceevent-92.webp' },
  ],
  guestCountHeadline: 'How many guests?',
  guestCountSubtext: 'Helps us recommend the right space',
  guestCountOptions: [
  ...
  roles: [
    { label: 'Event Organizer', img: '/images/roostertail-82_websize.webp' },
    { label: 'Family Member', img: '/images/roostertail-204_websize.webp' },
    { label: 'Event Planner', img: '/images/roostertail-501_websize.webp' },
    { label: 'Other', img: '/images/roostertail-833_websize.webp' },
  ],
  roleHeadline: 'Who are you?',
  roleSubtext: 'Helps us personalize your experience',
