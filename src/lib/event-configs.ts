...
export const corporateConfig: EventConfig = {
  ...
  faq: [
    ...
    { question: 'Can we bring in outside vendors?', answer: 'We handle catering and bar service in-house, but welcome outside decor and AV vendors. Our coordinator will help manage all vendor logistics.' },
  ],
...
export const holidayConfig: EventConfig = {
  ...
  faq: [
    { question: 'How early should we book for Christmas?', answer: 'Prime December dates fill up fast. We recommend inquiring by September or October to secure your preferred date.' },
    { question: 'Can you handle large company parties?', answer: 'Absolutely. Our venue accommodates up to 400+ guests and we regularly host corporate Christmas events for large organizations.' },
  ...
  ctaSubtext: 'Talk to one of our event coordinators about your Christmas party.',
...
export const birthdayConfig: EventConfig = {
  ...
  features: [
    ...
    { icon: '🥂', title: 'Full bar service', desc: 'Open bar, cash bar, or custom packages' },
    { icon: '🎶', title: 'Dance floor', desc: 'Spacious dance floor and sound system' },
  ...
  faq: [
    ...
    { question: 'Can we bring our own DJ?', answer: 'Yes! You can bring your own DJ or band. Our venue has a professional sound system ready to use.' },
  ],
...
export const otherConfig: EventConfig = {
  ...
  features: [
    ...
    { icon: '🎶', title: 'Dance floor & stage', desc: 'Sound system, stage, and dance floor' },
