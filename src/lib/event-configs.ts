...
export const corporateConfig: EventConfig = {
  ...
  dateOptions: [
    { label: 'This month', icon: '📅', img: '/images/roostertail-475_websize.webp' },
    { label: 'Next 1-3 months', icon: '🗓️', img: '/images/roostertail-586_websize.webp' },
    { label: '3-6 months out', icon: '📆', img: '/images/roostertail-82_websize.webp' },
    { label: '6+ months out', icon: '🔮', img: '/images/roostertail-204_websize.webp' },
  ],
  guestCountHeadline: 'How many attendees?',
  guestCountSubtext: 'Helps us recommend the right room configuration',
  guestCountOptions: [
    { label: 'Under 50', icon: '👥', img: '/images/roostertail-848_websize.webp' },
    { label: '50-150', icon: '🏢', img: '/images/roostertail-212_websize.webp' },
    { label: '150-300', icon: '🎉', img: '/images/guests-packed-ballroom-event.webp' },
  ...
  roles: [
    ...
    { label: 'Manager', img: '/images/roostertail-475_websize.webp' },
    { label: 'Employee / Admin', img: '/images/roostertail-586_websize.webp' },
    { label: 'Event Planner', img: '/images/roostertail-848_websize.webp' },
...
export const holidayConfig: EventConfig = {
  ...
  heroOptions: [
    { label: 'Yes!', img: '/images/holiday-roostertail-588_websize.webp' },
  ...
  guestCountOptions: [
    ...
    { label: '150-300', icon: '🥂', img: '/images/holiday-roostertail-848_websize.webp' },
...
export const promConfig: EventConfig = {
  ...
  heroOptions: [
    { label: 'Yes!', img: '/images/events/dsc05537.webp' },
    { label: 'Not yet', img: '/images/events/greetingcardconferenceevent-348.webp' },
  ],
  ...
  aboutImages: ['/images/first-dance-colorful-led.webp', '/images/first-dance-ballroom-crowd.webp'],
  faq: [
  ...
  dateOptions: [
    { label: 'April 2027', icon: '🌷', img: '/images/led-dance-floor-the-tail-logo.webp' },
    { label: 'May 2027', icon: '🌸', img: '/images/venue-exterior-night-fountains.webp' },
    { label: 'June 2027', icon: '☀️', img: '/images/hora-chair-dance-celebration.webp' },
    { label: '2028 or later', icon: '🔮', img: '/images/events/greetingcardconferenceevent-92.webp' },
  ],
  guestCountHeadline: 'How many students?',
  guestCountSubtext: 'Helps us plan the right setup',
  guestCountOptions: [
    { label: '50-100', icon: '🎓', img: '/images/events/greetingcardconferenceevent-25.webp' },
    { label: '100-200', icon: '💃', img: '/images/events/greetingcardconferenceevent-348.webp' },
  ...
  roles: [
    ...
    { label: 'Parent', img: '/images/events/greetingcardconferenceevent-25.webp' },
    { label: 'Teacher / Advisor', img: '/images/first-dance-sunset-windows.webp' },
    { label: 'Prom Committee', img: '/images/hora-chair-dance-celebration.webp' },
  ],
  roleHeadline: 'Who are you?',
  roleSubtext: 'Helps us personalize your experience',
...
export const birthdayConfig: EventConfig = {
  ...
  heroQuestion: 'Have you celebrated at The Roostertail?',
  heroOptions: [
    { label: 'Yes!', img: '/images/events/greetingcardconferenceevent-92.webp' },
    { label: 'Not yet', img: '/images/events/470.webp' },
  ],
  ...
  aboutImages: ['/images/venue-exterior-night-fountains.webp', '/images/signature-drinks-bar-sign.webp'],
  faq: [
  ...
  dateOptions: [
    { label: 'This month', icon: '🎂', img: '/images/roostertail-263_websize.webp' },
    { label: 'Next 1-3 months', icon: '🎈', img: '/images/roostertail-833_websize.webp' },
    { label: '3-6 months out', icon: '📅', img: '/images/roostertail-475_websize.webp' },
    { label: '6+ months out', icon: '🔮', img: '/images/catering-hors-doeuvres-service.webp' },
  ],
  guestCountHeadline: 'How many guests?',
  guestCountSubtext: 'Helps us recommend the right setup',
  guestCountOptions: [
    { label: 'Under 50', icon: '🎂', img: '/images/events/canned-seltzers-ice-bucket-bar-display.webp' },
    { label: '50-100', icon: '🎈', img: '/images/roostertail-82_websize.webp' },
    { label: '100-200', icon: '🎉', img: '/images/roostertail-934_websize.webp' },
    { label: '200+', icon: '✨', img: '/images/roostertail-486_websize.webp' },
  ],
  ...
  roles: [
    { label: 'The Birthday Person', img: '/images/events/greetingcardconferenceevent-25.webp' },
    { label: 'Family Member', img: '/images/signature-drinks-bar-sign.webp' },
    { label: 'Friend / Partner', img: '/images/roostertail-848_websize.webp' },
...
export const showerConfig: EventConfig = {
  ...
  heroQuestion: 'Have you been to an event at The Roostertail?',
  heroOptions: [
    { label: 'Yes!', img: '/images/events/reception-ballroom-cathedral-ceiling-white-gold-decor.webp' },
    { label: 'Not yet', img: '/images/catering-hors-doeuvres-service.webp' },
  ],
  ...
  testimonials: [
    ...
    },
    {
      ...
      name: 'Rand S.',
      img: '/images/waterfront-tablescape-chiavari-chairs.webp',
    },
    {
  ...
  aboutImages: ['/images/champagne-tower-bride-pouring.webp', '/images/catering-hors-doeuvres-service.webp'],
  faq: [
  ...
  dateSubtext: 'Helps us check availability',
  dateOptions: [
    { label: 'This month', icon: '🎀', img: '/images/events/elegant-place-setting-emerald-table-runner-overhead.webp' },
    { label: 'Next 1-3 months', icon: '🌸', img: '/images/events/greetingcardconferenceevent-348.webp' },
    { label: '3-6 months out', icon: '📅', img: '/images/events/canned-seltzers-ice-bucket-bar-display.webp' },
    { label: 'Just exploring', icon: '🔮', img: '/images/roostertail-242_websize.webp' },
  ],
  guestCountHeadline: 'How many guests?',
  guestCountSubtext: 'Helps us recommend the right space',
  guestCountOptions: [
    { label: 'Under 30', icon: '🎀', img: '/images/signature-drinks-bar-sign.webp' },
    { label: '30-60', icon: '🌸', img: '/images/events/reception-ballroom-cathedral-ceiling-white-gold-decor.webp' },
    { label: '60-100', icon: '🥂', img: '/images/waterfront-tablescape-chiavari-chairs.webp' },
  ...
  roles: [
    { label: 'The Bride / Guest of Honor', img: '/images/champagne-tower-bride-pouring.webp' },
    { label: 'Mother / Family Member', img: '/images/saxophonist-florals-waterfront.webp' },
    { label: 'Maid of Honor / Friend', img: '/images/events/470.webp' },
...
export const otherConfig: EventConfig = {
  ...
  testimonials: [
    {
      ...
      img: '/images/events/dsc05537.webp',
    },
    {
      ...
      img: '/images/led-dance-floor-the-tail-logo.webp',
    },
    {
  ...
  gallery: [
    ...
    { src: '/images/events/dsc05537.webp', alt: 'Event celebration' },
  ],
  ...
  aboutImages: ['/images/saxophonist-florals-waterfront.webp', '/images/guests-packed-ballroom-event.webp'],
  faq: [
  ...
  dateSubtext: 'Helps us check availability',
  dateOptions: [
    { label: 'This month', icon: '📅', img: '/images/saxophonist-florals-waterfront.webp' },
    { label: 'Next 1-3 months', icon: '🗓️', img: '/images/first-dance-ballroom-crowd.webp' },
    { label: '3-6 months out', icon: '📆', img: '/images/first-dance-sunset-windows.webp' },
    { label: 'Just exploring', icon: '🔮', img: '/images/first-dance-colorful-led.webp' },
  ],
  guestCountHeadline: 'How many guests?',
  guestCountSubtext: 'Helps us recommend the right space',
  guestCountOptions: [
    { label: 'Under 50', icon: '👥', img: '/images/guests-packed-ballroom-event.webp' },
    { label: '50-150', icon: '🎉', img: '/images/events/cocktail-hour-guests-mingling-paper-lanterns.webp' },
    { label: '150-300', icon: '🥂', img: '/images/events/lobster-steak-dinner-plates-server-tray.webp' },
    { label: '300+', icon: '✨', img: '/images/events/reception-ballroom-cathedral-ceiling-white-gold-decor.webp' },
  ],
  detailsHeadline: 'Tell us about your event',
  ...
  roles: [
    { label: 'Event Organizer', img: '/images/first-dance-colorful-led.webp' },
    { label: 'Family Member', img: '/images/first-dance-ballroom-crowd.webp' },
    { label: 'Event Planner', img: '/images/hora-chair-dance-celebration.webp' },
    { label: 'Other', img: '/images/first-dance-sunset-windows.webp' },
  ],
  roleHeadline: 'Who are you?',
  roleSubtext: 'Helps us personalize your experience',
