...
export const otherConfig: EventConfig = {
  ...
  dateSubtext: 'Helps us check availability',
  dateOptions: [
    { label: 'This month', icon: '📅', img: '/images/events/greetingcardconferenceevent-25.webp' },
    { label: 'Next 1-3 months', icon: '🗓️', img: '/images/events/greetingcardconferenceevent-294.webp' },
    { label: '3-6 months out', icon: '📆', img: '/images/roostertail-848_websize.webp' },
    { label: 'Just exploring', icon: '🔮', img: '/images/events/greetingcardconferenceevent-92.webp' },
  ],
  guestCountHeadline: 'How many guests?',
  guestCountSubtext: 'Helps us recommend the right space',
  guestCountOptions: [
